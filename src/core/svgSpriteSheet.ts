...
export async function createSpriteSheetSvg(
  ...
  const [
    ...
    rasterizeElement(
      Ship(shipColorsFromHull(colors.player1)),
      size.w,
      size.h,
      options,
    ),
    rasterizeElement(
      Ship(shipColorsFromHull(colors.player2)),
      size.w,
      size.h,
      options,
    ),
    rasterizeElement(
      Ship(shipColorsFromHull(colors.playerDead)),
      size.w,
      size.h,
      options,
    ),
    ...
    rasterizeElement(
      ExplosionFrame1(),
      EXPLOSION_SVG_SIZE.w,
      EXPLOSION_SVG_SIZE.h,
      options,
    ),
    rasterizeElement(
      ExplosionFrame2(),
    ...
    rasterizeElement(
      HitFlash(),
      HIT_FLASH_SVG_SIZE.w,
      HIT_FLASH_SVG_SIZE.h,
      options,
    ),
    rasterizeElement(
      MuzzleFlash(),
      MUZZLE_FLASH_SVG_SIZE.w,
      MUZZLE_FLASH_SVG_SIZE.h,
      options,
    ),
